  ...
  pre: {
    ...
    questions: [
      ...
      { id: 'q2', type: 'radio', required: true,
        ...
        options: ['공학미적분학(II)', '공학선형대수학', '수학(II)', '수학(II) 실습', '공업수학(II)', '기초수학', '이산수학', '과학수학', '응용복소해석학(II)', '실생활과 수학적 모델링', '해석학교육특론'] },
...
/* 교과목별 실제 운영 분반·담당교수 (2026, 부산대 제공 기준) — 분반 문항에서 사용
 * 각 항목: [분반번호, '담당교수']  → 보기에 "N분반 (교수명 교수님)" 으로 표시 */
window.COURSE_SECTIONS = {
  '공학미적분학(II)': [[1, '서연숙'], [66, '이경희']],
  '공학선형대수학': [[1, '이진기'], [1, '조유영'], [2, '류성주'], [3, '신미화'], [10, '조유영'], [62, '이진기'], [63, '정다운'], [64, '신미화'], [65, '류성주']],
  '수학(II)': [[3, '서연숙'], [4, '이한울']],
  '수학(II) 실습': [[1, '이미진']],
  '공업수학(II)': [[1, '정정미'], [2, '정정미']],
  '기초수학': [[30, '정다운']],
